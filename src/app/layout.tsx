...
export const metadata: Metadata = {
  title: "Grandview Hotel - Luxury 5-Star Hotel Experience",
  description: "Experience unparalleled luxury at Grandview Hotel. Premium rooms, world-class amenities, fine dining, and exceptional service await you.",
  keywords: "luxury hotel, 5-star hotel, premium accommodation, spa, fine dining, business hotel",
  openGraph: {
    title: "Grandview Hotel - Luxury 5-Star Hotel Experience",
    description: "Experience unparalleled luxury at Grandview Hotel. Premium rooms, world-class amenities, fine dining, and exceptional service await you.",
    ...
    images: [
      {
        ...
        alt: "Luxury hotel lobby with modern elegant interior"
      }
    ],
    type: "website"
  },
